...
export function DashboardScrollShell({ children, headerRight }: DashboardScrollShellProps) {
  return (
    <main
      className="min-h-screen bg-gray-200 text-gray-900 dark:bg-slate-800 dark:text-slate-100"
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <header className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-400">Welcome back, User</p>
          </div>
          {headerRight ? (
