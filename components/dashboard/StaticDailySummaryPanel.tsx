...
export function StaticDailySummaryPanel() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-[0_18px_36px_-12px_rgba(15,23,42,0.2)] ring-1 ring-slate-100 p-6 mb-6 transition-shadow">
      <div className="flex justify-between items-center mb-2 bg-white z-10 pb-2">
        <h2 className="text-2xl font-bold text-black">🧃 Morning Juice</h2>
      ...
      {/* Time Clashes */}
      <div className="mb-4 rounded-lg border border-red-200 shadow-sm bg-gradient-to-br from-red-50 via-white to-red-50 overflow-hidden">
      ...
      {/* Inferred Facts */}
      <div className="mb-4">
        <h3 className="font-semibold mb-1 text-black">Inferred Facts</h3>
        <ul className="space-y-1">
          <li className="group flex items-start justify-between p-2 bg-gray-50 rounded border hover:bg-gray-100">
            <div className="flex-1 pr-3">
              <span className="text-gray-800">💡 Project deadline moved to next week</span>
          ...
          <li className="group flex items-start justify-between p-2 bg-gray-50 rounded border hover:bg-gray-100">
            <div className="flex-1 pr-3">
              <span className="text-gray-800">💡 New feature request from client</span>
              <div className="text-xs text-gray-500 mt-2 ml-7">
                📧 11:15 AM • Mon Dec 16
              </div>
            </div>
      ...
      {/* Todos */}
      <div className="mb-4">
        <h3 className="font-semibold mb-1 text-black">Todos</h3>
        <ul className="space-y-2">
          <li className="group flex items-start p-3 bg-gray-50 rounded-lg border">
            <div className="flex items-center mr-3">
              <span className="text-lg">📝</span>
            </div>
            <div className="flex-1">
              <div className={`font-medium mb-2 text-black transition-all ${checkedTodos.has(0) ? 'line-through text-gray-400' : ''}`}>
          ...
          <li className="group flex items-start p-3 bg-gray-50 rounded-lg border">
            ...
            <div className="flex-1">
              <div className={`font-medium mb-2 text-black transition-all ${checkedTodos.has(1) ? 'line-through text-gray-400' : ''}`}>
      ...
      {/* Events Timeline */}
      <div>
        <h3 className="font-semibold mb-1 text-black">Events</h3>
        <ul className="space-y-2">
          <li className="group flex flex-col sm:flex-row items-start sm:items-center gap-2 p-3 bg-gray-50 rounded-lg border">
            <div className="flex items-center gap-2 flex-1 min-w-0">
              <span className="text-lg flex-shrink-0">📅</span>
              <span className="font-medium truncate text-black">Team Standup</span>
            </div>
            <div className="w-full sm:w-40 text-left sm:text-right text-sm text-gray-600 whitespace-nowrap sm:ml-16">
              10:00 AM - 10:30 AM
            </div>
          ...
          <li className="group flex flex-col sm:flex-row items-start sm:items-center gap-2 p-3 bg-gray-50 rounded-lg border">
            <div className="flex items-center gap-2 flex-1 min-w-0">
              <span className="text-lg flex-shrink-0">📅</span>
              <span className="font-medium truncate text-black">Client Meeting</span>
            </div>
            <div className="w-full sm:w-40 text-left sm:text-right text-sm text-gray-600 whitespace-nowrap sm:ml-16">
              10:15 AM - 11:00 AM
            </div>
